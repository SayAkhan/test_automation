...
def drm_h264_combinations():
    ...
    # 결과를 파일에 저장
    with open('drm_combinations.txt', 'a', encoding='utf-8') as f:
...
def fwm_h264_combinations():
    ...
    # 결과를 파일에 저장
    with open('fwm_combinations.txt', 'a', encoding='utf-8') as f:
        f.write(f"\n=== {options['작업타입'][0]} {options['출력 코덱'][0]} 조합 ===\n")
        f.write(f"총 조합 수: {len(combinations)}\n\n")
        for combo in combinations:
            combination_counter += 1
...
if __name__ == "__main__":
    # 파일 초기화
    with open('drm_combinations.txt', 'w', encoding='utf-8') as f:
        f.write("")
    with open('fwm_combinations.txt', 'w', encoding='utf-8') as f:
        f.write("")
    ...
    print("\n총 조합 수:")
    print("DRM 관련 총 조합 수: 644 (160 + 160 + 320 + 4)")
    print("FWM 관련 총 조합 수: 20 (8 + 4 + 4 + 4)")
